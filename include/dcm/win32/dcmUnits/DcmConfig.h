...
*/
struct DCMTK_DCMQRDB_EXPORT DcmConfigFileQuota
{
...
*/
struct DCMTK_DCMQRDB_EXPORT DcmConfigFilePeer
{
...
*/
struct DCMTK_DCMQRDB_EXPORT DcmConfigFileAEEntry
{
...
*/
struct DCMTK_DCMQRDB_EXPORT DcmConfigFileHostTable
{
    /// number of entries
    int noOfHostEntries;

    /// array of entries
    DcmConfigFileHostEntry   *HostEntries;
};

/** this class describes configuration settings for a Query/Retrieve SCP Service
*/
class DCMTK_DCMQRDB_EXPORT DcmConfigFile
{
...
private:
    ...
    */
    DcmConfigFilePeer *parsePeers(char **valuehandle, int *peers);
    ...
    *  Return : pointer to peer list
    */
    DcmConfigFilePeer *readPeerList(char **valuehandle, int *peers);
    ...
    */
    static DcmConfigFileQuota *parseQuota(char **valuehandle);
    ...
    */
    ...
    DcmConfigFileHostTable CNF_VendorTable;  /* Vendor Table */
