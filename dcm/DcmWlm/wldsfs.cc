...
//                WLM_FAILED_IDENTIFIER_DOES_NOT_MATCH_SOP_CLASS - Error in the search mask encountered.
{
    ...
    unsigned long numOfMatchingRecords = fileSystemInteractionManager.DetermineMatchingRecords(identifiers, GetDcmConfig());
...
DcmConfigFile*  WlmDataSourceFileSystem::GetDcmConfig() const
{
    return  m_ConfigFile;
}
void  WlmDataSourceFileSystem::SetDcmConfig(DcmConfigFile* ConfigFile)
{
    m_ConfigFile = ConfigFile;
    fileSystemInteractionManager.SetDcmConfig(ConfigFile);
}