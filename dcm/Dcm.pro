...
SUBDIRS += dcmdata dcmjpeg   dcmjpls dcmlog dcmnet dcmqrdb dcmqrScp dcmsr dcmstd dcmtls dcmUnits DcmWlm libi2d SaveDcmInfoDb \
    dcmimage     dcmimgle  StoreDcmScp StoreDcmScu WorklistScp
