...
CREATE TABLE IF NOT EXISTS `h_patient` (
  ...
  `PatientAddr` varchar(120) DEFAULT '""' COMMENT '地址',
  `PatientEmail` varchar(50) DEFAULT '""' COMMENT '电子邮件地址',
  `PatientCarID` varchar(50) DEFAULT '""' COMMENT '身份ID:身份证',
  `PatientTelNumber` varchar(50) DEFAULT '""' COMMENT '电话号码',
  `PatientType` int(11) DEFAULT 0 COMMENT '费用类型：0.自费 2.公费 3.半公费4.其它',
  `PatientState` int(11) DEFAULT 0 COMMENT '标记状态 小于0为标记删除',
  `PatientJob` varchar(100) DEFAULT 'JOB' COMMENT '职业',
