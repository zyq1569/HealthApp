#ifndef __tonoka_destination__
#define __tonoka_destination__
...
class tonoka_destination : public destination
{
	protected:
	...
	public:
		/** Constructor */
		tonoka_destination( wxWindow* parent );
