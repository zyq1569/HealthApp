...
tonoka_destination::tonoka_destination( wxWindow* parent )
:
destination( parent )
{
	invalidInput = ",";
...
void tonoka_destination::OnDeselected( wxListEvent& event )
{
...
void tonoka_destination::OnDelete( wxCommandEvent& event )
{
...
void tonoka_destination::OnEcho( wxCommandEvent& event )
{
int sel = GetSelectedDestinationItem();
if (sel == -1)
return;
...
void tonoka_destination::OnNameText( wxCommandEvent& event )
{
UpdateItem();
