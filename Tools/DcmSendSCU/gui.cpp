...
mainFrame::mainFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
    ...
    fgSizer1->Add( m_directory, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 5 );
    
    m_button6 = new wxButton( this, wxID_ANY, _("Browse..."), wxDefaultPosition, wxDefaultSize, 0 );
    fgSizer1->Add( m_button6, 0, wxALL, 5 );
    
    m_staticText171 = new wxStaticText( this, wxID_ANY, _("Depth:"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_move = new wxButton( this, wxID_ANY, _("Send"), wxDefaultPosition, wxDefaultSize, 0 );
...
about::about( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    ...
    m_hyperlink1 = new wxHyperlinkCtrl( this, wxID_ANY, wxEmptyString, wxT("http://www.draconpern.com/software/tonoka"), wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
