...
class dovo_mainFrame : public mainFrame
{
    protected:
        ...
        void OnStudiesRightClick( wxListEvent& event);
        void OnSeriesRightClick(wxListEvent& event);
        void OnSendStudy(wxCommandEvent& event);
        void OnSendSeries(wxCommandEvent& event);
    public:
        /** Constructor */
