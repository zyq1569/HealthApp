...
mainFrame::mainFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
    ...
    m_sendstudy = new wxButton( this, wxID_ANY, _("Send Study"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer161->Add( m_sendstudy, 0, wxALL, 5 );

    m_sendseries = new wxButton( this, wxID_ANY, _("Send Series"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer161->Add( m_sendseries, 0, wxALL, 5 );
    ...
    m_studies->Connect( wxEVT_COMMAND_LIST_ITEM_RIGHT_CLICK, wxListEventHandler( mainFrame::OnStudiesRightClick ), NULL, this );
    ...
    m_quicksend->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( mainFrame::OnQuickSend ), NULL, this );
    m_sendstudy->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( mainFrame::OnSendStudy ), NULL, this );
    m_sendseries->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( mainFrame::OnSendSeries ), NULL, this );
...
mainFrame::~mainFrame()
{
    ...
    m_studies->Disconnect( wxEVT_COMMAND_LIST_ITEM_RIGHT_CLICK, wxListEventHandler( mainFrame::OnStudiesRightClick ), NULL, this );
    ...
    m_quicksend->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( mainFrame::OnQuickSend ), NULL, this );
    m_sendstudy->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( mainFrame::OnSendStudy ), NULL, this );
    m_sendseries->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( mainFrame::OnSendSeries ), NULL, this );
...
about::about( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    ...
    m_hyperlink1 = new wxHyperlinkCtrl( this, wxID_ANY, wxEmptyString, wxT("https://www.draconpern.com/software/dovo"), wxDefaultPosition, wxDefaultSize, wxHL_DEFAULT_STYLE );
