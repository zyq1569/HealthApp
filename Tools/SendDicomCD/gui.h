...
class mainFrame : public wxFrame
{
    ...
    protected:
        ...
        wxButton* m_sendstudy;
        wxButton* m_sendseries;
        wxPanel* m_panel3;
        wxButton* m_about;
        wxButton* m_exit;
        ...
        virtual void OnStudiesRightClick( wxListEvent& event ) { event.Skip(); }
        ...
        virtual void OnSendStudy( wxCommandEvent& event ) { event.Skip(); }
        virtual void OnSendSeries( wxCommandEvent& event ) { event.Skip(); }
