...
isEmpty(DCMTKINCLUDEDIR){
    ...
    win32:DCMTKINCLUDEDIR = D:/code/C++/starviewer-sdk/dcmtk-3.6.3
...
isEmpty(VTKINCLUDEDIR){
    ...
    win32:VTKINCLUDEDIR = D:/code/C++/starviewer-sdk/VTK-8.2.0/Imaging/Core
    win32:contains(QMAKE_TARGET.arch, x86_64):VTKINCLUDEDIR = D:/code/C++/starviewer-sdk/VTK-8.2.0/Imaging/Core
}
...
isEmpty(ITKINCLUDEDIR){
    ...
    win32:ITKINCLUDEDIR = D:/code/C++/starviewer-sdk/InsightToolkit-5.0.1/Modules/Core/Common/include
    win32:contains(QMAKE_TARGET.arch, x86_64):ITKINCLUDEDIR = D:/code/C++/starviewer-sdk/InsightToolkit-5.0.1/Modules/Core/Common/include
}
...
isEmpty(GDCMINCLUDEDIR){
    ...
    win32:GDCMINCLUDEDIR = D:/code/C++/starviewer-sdk/gdcm-3.0.5/Source
...
isEmpty(LOG4CXXINCLUDEDIR){
    ...
    win32:LOG4CXXINCLUDEDIR =D:/code/C++/starviewer-sdk/apache-log4cxx/src/main/include
    win32:contains(QMAKE_TARGET.arch, x86_64):LOG4CXXINCLUDEDIR =D:/code/C++/starviewer-sdk/apache-log4cxx/src/main/include
...
isEmpty(THREADWEAVERINCLUDEDIR){
    ...
    win32:THREADWEAVERINCLUDEDIR = D:/code/C++/starviewer-sdk/threadweaver/src
