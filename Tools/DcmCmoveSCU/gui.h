...
class mainFrame : public wxFrame 
{
    ...
    public:
        ...
        mainFrame( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("CmoveSCU"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 625,426 ), long style = wxDEFAULT_FRAME_STYLE|wxRESIZE_BORDER|wxTAB_TRAVERSAL );
