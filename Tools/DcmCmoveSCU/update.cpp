...
bool informUserOfUpdate(std::string json)
{
    ...
    try
    {
        ...
        version = pt.get_child("CmoveSCU.version").data();
        mustupdate = pt.get_child("CmoveSCU.mustupdate").data();
        message = pt.get_child("CmoveSCU.message").data();
    ...
    if (version != thisversion)
    {
        ...
        updatecheckdlg.m_updatetext = wxT("A new version of CmoveSCU is available:");
        updatecheckdlg.ShowModal();
    }
...
int getUpdateJSON(std::string &updateinfo)
{
    ...
    try
    {
        ...
        std::string checkurl = "/software/CmoveSCU/";
        ...
        request_stream << "User-Agent: CmoveSCU/" << FINACO_VERSION;
